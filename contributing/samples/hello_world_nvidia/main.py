...
async def main():
  ...
  if not os.environ.get("NVIDIA_NIM_API_KEY"):
    print("⚠️  NVIDIA_NIM_API_KEY not set. Please set it before running:")
    print("   export NVIDIA_NIM_API_KEY='your-nvidia-api-key'")
    print("   export NVIDIA_NIM_API_BASE='https://integrate.api.nvidia.com/v1/'  # Optional")
    print("\nYou can get an NVIDIA API key from:")
    print("https://www.nvidia.com/en-us/ai-data-science/cloud/")
    return
